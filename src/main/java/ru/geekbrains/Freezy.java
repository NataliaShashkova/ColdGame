...
public class Freezy {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            printMap();
            if (checkWin(DOT_X)) {
                System.out.println("Ты не замерзнешь");
                break;
            }
            if (isMapFull()) {
                System.out.println("Лед проплывет мимо");
                break;
            }
            aiTurn();
            printMap();
            if (checkWin(DOT_O)) {
                System.out.println("Я заберу твое тепло");
                break;
            }
            if (isMapFull()) {
                System.out.println("Лед проплвет мимо");
                break;
            }
        }
    ...
    public static boolean checkWin(char symb) {
        ...
        return map[0][4] == symb && map[1][4] == symb && map[2][4] == symb && map[3][4] == symb && map[4][4] == symb;
    }
